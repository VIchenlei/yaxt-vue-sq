    ...
    <a-row type="flex">
      ...
      <a-col>
        ...
        <div v-if="actionButton" class="action-button">
          ...
          <a-button class="draw-path" v-if="drawPath" type="primary" icon="plus" name="add" @click="handleDrawPath">画取路径</a-button>
          <a-button class="draw-path" v-if="drawPath" type="primary" icon="plus" name="edit" @click="handleDrawPath">编辑路径</a-button>
        </div>
      </a-col>
      <a-col>
  ...
  export default {
    ...
    methods: {
      ...
      add(num = 1, forceScrollToBottom = false) {
        if (num < 1) return
        // if (this.$parent.added instanceof Function) {
        //   this.$parent.added();
        //   return
        // }
        // let timestamp = new Date().getTime()

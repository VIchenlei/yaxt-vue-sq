 ...
 */
function getCanvasList (x, y, data) {
  console.log(x, y)
  let angleZeroCoord = []
  let canCoords = []
  angleZeroCoord.push(getAantennaAngle(x, y, data.aerialaX, data.aerialaY))
  angleZeroCoord.push(getAantennaAngle(x, y, data.aerialbX, data.aerialbY))
  canCoords.push(getAntennaCoord(60, 60, 50, angleZeroCoord[0]))
  canCoords.push(getAntennaCoord(60, 60, 50, angleZeroCoord[1]))
  return canCoords
}
